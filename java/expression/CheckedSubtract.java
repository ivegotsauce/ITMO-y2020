...
public class CheckedSubtract<T> extends Operation<T> implements Expression<T>, TripleExpression<T> {

    public CheckedSubtract(ToMiniString<T> exp1, ToMiniString<T> exp2) {
        super(exp1, exp2);
    }
